    ...
    if resposta_login.status_code == 200:
        ...
        if not session_token:
            ...
            if resposta_export.status_code == 200:
                ...
                print(f"Erro ao exportar usuários: {resposta_export.status_code}")
                print(f"Resposta do servidor: {resposta_export.text}")
        ...
        print(f"Resposta do servidor: {resposta_login.text}")
